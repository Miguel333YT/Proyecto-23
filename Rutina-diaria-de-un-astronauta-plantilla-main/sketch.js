...
function setup() {
  ...
  //aqui se crea el sprite dela astronauta, su imagen, animacion y tamaño
...
function draw() {
  ...
  //aqui se coloca el texto de las instrucciones que se ven en el lienzo
  textSize(20);
  fill("white")
  ...
  //aqui se crean los bordes y la configuracion para que el astronauta rebote en ellos
  edges=createEdgeSprites();
  astronaut.bounceOff(edges);

  //aqui se crea la configuracion para que cuando se presionen ciertas teclas, el astronauta haga ciertas acciones
  if(keyDown("UP_ARROW")){
